...
function holdLayer(names: PlateNames): LooseLayer {
  return {
    ...
    animation: {
      ...
      hueSpace: "oklch",
      greenCompress: 0.4,
      saturationBoost: 1.74,
      valueLift: 0,
      luminanceKey: 0,
      hueKey: 0,
      hueSpeed: 0,
      satInjectionMul: 0.001,
      satBlendLow: 0.08,
      satBlendHigh: 0.58,
      paletteAmount: 0,
      noiseAmount: 0,
      ...
      phaseField2: "layers/phase-luma-hybrid.png",
      flowField: "layers/flow-field.png",
      phaseAmount: 0,
      phaseWarpAmount: 0,
      glowWavePhaseSource: "flowField",
      // r346 v11 figure layer (Isaac final): the hold is a *textured* second language, not a frozen sticker.
      // The old surface6/flow6/floor0.08 default produced "사람 형태가 너무 정적이야" on every dark figure.
      glowWave: { strength: 0.58, speed: 12, sharpness: 0.38, fieldCycles: 1.35 },
      glowWave2: { strength: 0.36, speed: 22, sharpness: 0.28, fieldCycles: 1.85 },
      ...
      sourceColorClamp: { maxDrift: 0.42 },
      breath: { amplitude: 0.004, frequency: 0.8, period: 20 },
      // floor 1 = dark body pixels receive the prism too (r346 v8/v9 black-window failures).
      colorMotionMask: {
        floor: 1,
        luminanceWeight: 0,
        saturationWeight: 0,
