 ...
 *
 * - commercial (default): Enterprise vivid look (sat 4.4/5.4/3.8, godRays 1.1, bloom 1.0).
 * - elegant: Restrained tasteful look (sat 2.4/2.6/1.95, godRays 0.55, bloom 0.55).
 */

export type Tone = "commercial" | "elegant";
...
export const DEFAULT_TONE: Tone = "commercial";
